<?php
/* Smarty version 3.1.29, created on 2016-06-06 02:43:21
  from "/home/ubuntu/workspace/templates/Sales/view_sales_page.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5754e349f01a58_06905003',
  'file_dependency' => 
  array (
    '3a867b464762ad8a0154661b068a4b159d3b52c6' => 
    array (
      0 => '/home/ubuntu/workspace/templates/Sales/view_sales_page.tpl',
      1 => 1465180997,
      2 => 'file',
    ),
  ),
...
function content_5754e349f01a58_06905003 ($_smarty_tpl) {
...
$(function() {
     ...
     if($('input[name="customer_type"]:checked').val() == "一般客"){
       $("#mm").hide(); 
     }
       
      if($('input[name="customer_type"]:checked').val() == "會員"){
       $("#mm").show(); 
      }
...
">
     <div class="row" id="p1">
          ...
          <div class="col-md-2">
               <div class="input-group">
                    <input disabled="disabled" id="code<?php echo $_smarty_tpl->tpl_vars['foo']->value;?>
...
">
           ...
           <div class="col-md-2">
               <div class="input-group">
                    ...
                    <input disabled="disabled" id="name<?php echo $_smarty_tpl->tpl_vars['foo']->value;?>
...
" >
           ...
           <div class="col-md-1">
               <div class="input-group">
                    ...
                    <input disabled="disabled" type="number" class="form-control" name="product_quantity[]" id="quota<?php echo $_smarty_tpl->tpl_vars['foo']->value;?>
...
">
           ...
           <div class="col-md-1">
               <div class="input-group">
                    ...
                    <input disabled="disabled" type="text" class="form-control" name="product_discount[]" id="discount<?php echo $_smarty_tpl->tpl_vars['foo']->value;?>
