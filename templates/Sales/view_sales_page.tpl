...
<HR color="#8B4513" size="100" width=95%>
     ...
     <div class="row" id="p1">
          ...
          <div class="col-md-2">
               <div class="input-group">
                    <input disabled="disabled" id="code{$foo}"  type="text" class="form-control" name="product_code[]" value="{$row[$foo]['Code']}">
               </div>
          </div>
           <div class="col-md-2">
               <div class="input-group">
                    
                    <input disabled="disabled" id="name{$foo}"  type="text" class="form-control" name="product_name[]" value="{$row[$foo]['Product_name']}" >
               </div>
          </div>
           <div class="col-md-1">
               <div class="input-group">
                   
                    <input disabled="disabled" type="number" class="form-control" name="product_quantity[]" id="quota{$foo}" value="{$row[$foo]['Quantity']}">
               </div>
          </div>
           <div class="col-md-1">
               <div class="input-group">
           ...
           <div class="col-md-1">
               <div class="input-group">
                    ...
                    <input disabled="disabled" type="text" class="form-control" name="product_discount[]" id="discount{$foo}" value="{$row[$foo]['Discount']}">
               </div>
          </div>
           <div class="col-md-2">
               <div class="input-group">
                    
                    <input type="text" class="form-control" name="product_sum[]" id="sum{$foo}" disabled="disabled" value="">
